...
public class IncludeEventHandlingTestCase extends BaseTestCase implements IncludeEventHandler, RuntimeServicesAware
{
    ...
    public void setUp() throws Exception
    {
        ...
        engine.addProperty( RuntimeConstants.FILE_RESOURCE_LOADER_PATH, calcPathToTestDirectory( TEST_DIR, "include4", TMPL_FILE_EXT ) );
//      engine.setProperty( RuntimeConstants.RUNTIME_LOG_LOGSYSTEM_CLASS, TestLogChute.class.getName());
     ...
     * Runs the test.
     */
    public void testIncludeEventHandlingPassThrough() throws Exception
    {
        ...
        assertTrue( "Output incorrect.", isMatch( RESULTS_DIR, COMPARE_DIR, "test1", RESULT_FILE_EXT, CMP_FILE_EXT ) );
    }

    /**
     * Runs the test.
     */
    public void testIncludeEventHandlingRelative() throws Exception
    {
        Template template2 = engine.getTemplate( getFileName( null, "subdir/test2", TMPL_FILE_EXT ) );
        ...
        assertTrue( "Output incorrect.", isMatch( RESULTS_DIR, COMPARE_DIR, "test2", RESULT_FILE_EXT, CMP_FILE_EXT ) );
    }

    /**
     * Runs the test.
     */
    public void testIncludeEventHandlingBlock() throws Exception
    {
        Template template3 = engine.getTemplate( getFileName( null, "test3", TMPL_FILE_EXT ) );

        FileOutputStream fos3 = new FileOutputStream( getFileName( RESULTS_DIR, "test3", RESULT_FILE_EXT ) );
        ...
        assertTrue( "Output incorrect.", isMatch( RESULTS_DIR, COMPARE_DIR, "test3", RESULT_FILE_EXT, CMP_FILE_EXT ) );
    }

    /**
     * Check bug VELOCITY-717.
     */
    public void testIncludeEventHandlingBlockMacros() throws Exception
    {
        Template template = engine.getTemplate( getFileName( null, "test7", TMPL_FILE_EXT ) );

        FileOutputStream fos = new FileOutputStream( getFileName( RESULTS_DIR, "test7", RESULT_FILE_EXT ) );
        ...
        assertTrue( "Output incorrect.", isMatch( RESULTS_DIR, COMPARE_DIR, "test7", RESULT_FILE_EXT, CMP_FILE_EXT ) );
    }

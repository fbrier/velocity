...
{
    Logger logger = LoggerFactory.getLogger( ResourceLoaderFactory.class );
    ...
    public static ResourceLoader getLoader(RuntimeServices rs, String loaderClassName)
    {
        ...
        try
        {
            ...
            LoggerFactory.getLogger( ResourceLoaderFactory.class ).debug( "ResourceLoader instantiated: "
        ...
        catch(Exception e)
        {
            ...
            LoggerFactory.getLogger( ResourceLoaderFactory.class ).error( msg, e );

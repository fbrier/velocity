...
{
    Logger logger = LoggerFactory.getLogger( JarHolder.class );
    ...
    public JarHolder( RuntimeServices rs, String urlpath )
    {
        ...
        {
            logger.debug("JarHolder: initialized JAR: " + urlpath);
        }
    }
    ...
    public void init()
    {
        try
        {
            if (logger.isDebugEnabled())
            {
                logger.debug("JarHolder: attempting to connect to " + urlpath);
            }
    ...
    public void close()
    {
        ...
        logger.trace("JarHolder: JAR file closed");
    }
    ...
    public InputStream getResource( String theentry )
     throws ResourceNotFoundException {
        ...
        {
            logger.error("JarHolder: getResource() error", fnfe);

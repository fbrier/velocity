...
public class StringResourceLoader extends ResourceLoader
{
    ...
    {
        logger.trace("StringResourceLoader : initialization starting.");
        ...
        if (isStatic)
        {
            ...
            {
                logger.debug("Loaded repository '"+repoName+"' from static repo store");
            }
        }
        else
        {
            ...
            if (repository != null && logger.isDebugEnabled())
            {
                logger.debug("Loaded repository '"+repoName+"' from application attributes");
            }
        }
        ...
        else
        {
            ...
            {
                logger.debug("Cannot change class of string repository '"+repoName+
                ...
                !this.repository.getEncoding().equals(encoding))
            {
                ...
                {
                    logger.debug("Changing the default encoding of string repository '"+repoName+
        ...
        logger.trace("StringResourceLoader : initialization complete.");
    }
                                                     ...
                                                     final String encoding)
    {
        if (logger.isDebugEnabled())
        {
            logger.debug("Creating string repository using class "+className+"...");
        }
        ...
        if (logger.isDebugEnabled())
        {
            logger.debug("Default repository encoding is " + repo.getEncoding());
        }
        return repo;
    }

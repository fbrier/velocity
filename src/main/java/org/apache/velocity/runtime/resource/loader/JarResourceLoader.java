...
{
    Logger logger = LoggerFactory.getLogger( JarResourceLoader.class );
    ...
    {
        logger.trace("JarResourceLoader : initialization starting.");
        ...
        if( paths == null || paths.size() == 0)
        {
            ...
            if (paths != null && paths.size() > 0)
            {
                logger.debug("JarResourceLoader : you are using a deprecated configuration"
        ...
        if (paths != null)
        {
            logger.debug("JarResourceLoader # of paths : " + paths.size() );
        ...
        logger.trace("JarResourceLoader : initialization complete.");
    }
        ...
        throws ResourceNotFoundException
    {
        ...
        if ( normalizedPath == null || normalizedPath.length() == 0 )
        {
            ...
            logger.error( "JarResourceLoader : " + msg );

...
public class ResourceManagerImpl implements ResourceManager
{
    ...
    public synchronized void initialize(final RuntimeServices rsvc)
    {
        if (isInit)
        {
            logger.debug("Re-initialization of ResourceLoader attempted and ignored.");
            return;
        }
        ...
        logger.trace("Default ResourceManager initializing. (" + this.getClass() + ")");
        ...
        logger.trace("Default ResourceManager initialization complete.");
    }
    ...
    private void assembleResourceLoaderInitializers()
    {
        ...
        for (Iterator it = resourceLoaderNames.iterator(); it.hasNext(); )
        {
            ...
            {
                logger.debug("ResourceManager : No configuration information found "+
            ...
            ParseErrorException
    {
        ...
        if (resource != null)
        {
            ...
            {
                logger.error("ResourceManager.getResource() exception", pee);
                throw pee;
            }
            catch (RuntimeException re)
            {
                logger.error("ResourceManager.getResource() exception", re);
        	    throw re;
            }
        }
        else
        {
            ...
            {
                logger.error("ResourceManager : unable to find resource '" +
                          resourceName + "' in any resource loader.");
                throw rnfe;
            }
            catch (ParseErrorException pee)
            {
                logger.error("ResourceManager.getResource() parse exception", pee);
                throw pee;
            }
            catch (RuntimeException re)
            {
                logger.error("ResourceManager.getResource() load exception", re);
                throw re;
            }
        }
        ...
        throws ResourceNotFoundException, ParseErrorException
    {
        ...
        if (resource.isSourceModified())
        {
            ...
            {
                logger.warn("Declared encoding for template '" +
                             resource.getName() +

...
{
    Logger logger = LoggerFactory.getLogger( ASTIndex.class );
      ...
      if (argument instanceof Integer && ((Integer)argument).intValue() < 0)
      {
          ...
          if (method == null)
          {
              ...
              throw new VelocityException(
                "A 'size()' method required for negative value "
                 ...
                 + o.getClass().getName() + "' at " + Formatter.formatFileString( node ));
          }             
          ...
          catch (Exception e)
          {
              throw new VelocityException("Error trying to calls the 'size()' method on '"
                + o.getClass().getName() + "' at " + Formatter.formatFileString(node), e);
          }
          ...
          catch (ClassCastException e)
          {
              ...
              throw new VelocityException("Method 'size()' on class '" 
                  ...
                  + "' when Integer was expected at " + Formatter.formatFileString(node));
          }
        ...
        throws MethodInvocationException
    {
        ...
        catch( Exception e )
        {
            String msg = "Error invoking method 'get("
              ...
              + " at " + Formatter.formatFileString(this);
            logger.error(msg, e);

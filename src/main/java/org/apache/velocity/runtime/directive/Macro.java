...
{
    Logger logger = LoggerFactory.getLogger( Macro.class );
        ...
        throws IOException, ParseException
    {
        ...
        if (numArgs < 2)
        {
             ...
             *  define a block
             */
            LoggerFactory.getLogger( Macro.class ).error( "#macro error : Velocimacro must have name as 1st " +
    ...
    private static String[] getArgArray(Node node, RuntimeServices rsvc)
    {
        ...
        if (debugMode)
        {
            ...
            LoggerFactory.getLogger( Macro.class ).debug( msg.toString() );
        }

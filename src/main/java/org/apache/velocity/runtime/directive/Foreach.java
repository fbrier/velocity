...
{
    Logger logger = LoggerFactory.getLogger( Foreach.class );
        ...
        throws TemplateInitException
    {
        ...
        if (!warned && logger.isWarnEnabled())
        {
            ...
            {
                logger.warn( "The " + RuntimeConstants.COUNTER_NAME +
            ...
            {
                logger.warn( "The " + RuntimeConstants.HAS_NEXT_NAME +
                        " property has been deprecated. It will be removed" +
            ...
            {
                logger.warn( "The " + RuntimeConstants.COUNTER_INITIAL_VALUE +
                        " property has been deprecated. It will be removed" +
                        " (along with $velocityCount itself) in Velocity 2.0. " +
        ...
        if (i == null)
        {
            ...
            else
            {
                ...
                String msg = "#foreach parameter " + pnode.literal() + " at "
                    + Formatter.formatFileString( pnode )

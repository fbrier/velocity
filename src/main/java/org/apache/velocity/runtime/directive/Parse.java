...
{
    Logger logger = LoggerFactory.getLogger( Parse.class );
               ...
               MethodInvocationException
    {
        ...
        {
            logger.debug( "#parse(): null argument at " +
                    Formatter.formatFileString( this ) );
        }
        ...
        catch ( ResourceNotFoundException rnfe )
        {
             ...
             */
            logger.error("#parse(): cannot find template '" + arg +
        ...
        catch ( ParseErrorException pee )
        {
             ...
             *  note it and throw
             */
            logger.error("#parse(): syntax error in #parse()-ed template '"
                                + arg + "', called at " + Formatter.formatFileString(this));
            throw pee;
        }
        /**
        ...
        {
            logger.error("Exception rendering #parse(" + arg + ") at " +
                                Formatter.formatFileString(this));
            throw e;
        }
        catch ( Exception e)
